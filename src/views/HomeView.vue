        ...
        <div v-if="quizStarted">
            ...
            <div class="row mx-auto justify-content-md-center pb-5 gx-5">
                <div v-for="answerOption in answersArray" class="col-md-5 p-4">
                    <button class="btn btn-outline-dark py-3 w-100 text-light">{{ questions[questionNo][`answer_${answerOption}`] }}</button>
                </div>
            </div>
...
export default {
    ...
    setup() {
        ...
        return {answersArray, questions, questionNo, quizStarted, startQuiz}
    }
}
</script>
